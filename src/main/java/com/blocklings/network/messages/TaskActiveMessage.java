...
public class TaskActiveMessage implements IMessage
{
    Task task;
    boolean value;
    int entityId;

    public TaskActiveMessage()
    {
    }

    public TaskActiveMessage(Task task, boolean value, int entityID)
    {
        this.task = task;
        this.value = value;
    ...
    public static class Handler implements net.minecraftforge.fml.common.network.simpleimpl.IMessageHandler<TaskActiveMessage, IMessage>
    {
        public IMessage onMessage(TaskActiveMessage msg, MessageContext ctx)
        {
