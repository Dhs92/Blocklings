...
public class StateMessage implements IMessage
{
    ...
    public StateMessage(State value, int entityID)
    {
        this.value = value;
    ...
    {
        this.value = State.values()[buf.readInt()];
    ...
    public static class Handler implements net.minecraftforge.fml.common.network.simpleimpl.IMessageHandler<StateMessage, IMessage>
    {
        public IMessage onMessage(StateMessage msg, MessageContext ctx)
        {
            ...
            if (entity instanceof EntityBlockling)
            {
                ...
                blockling.setState(msg.value, ctx.side.isServer());
            }
