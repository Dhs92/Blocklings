...
public class CenteredTextFieldWidget extends Widget implements IRenderable, IGuiEventListener
{
    ...
    public CenteredTextFieldWidget(FontRenderer p_i51137_1_, int p_i51137_2_, int p_i51137_3_, int p_i51137_4_, int p_i51137_5_, String p_i51137_6_) {
        this(p_i51137_1_, p_i51137_2_, p_i51137_3_, p_i51137_4_, p_i51137_5_, (net.minecraft.client.gui.widget.TextFieldWidget)null, p_i51137_6_);
    }

    public CenteredTextFieldWidget(FontRenderer p_i51138_1_, int p_i51138_2_, int p_i51138_3_, int p_i51138_4_, int p_i51138_5_, @Nullable net.minecraft.client.gui.widget.TextFieldWidget p_i51138_6_, String p_i51138_7_) {
    ...
    protected String getNarrationMessage() {
        ...
        return lvt_1_1_.isEmpty() ? "" : I18n.format("gui.narrate.editBox", new Object[]{lvt_1_1_, this.text});
    }
    ...
    public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
        if (!this.getVisible()) {
            ...
            if (this.isFocused() && lvt_6_1_ && p_mouseClicked_5_ == 0) {
                ...
                lvt_7_1_ = lvt_7_1_ - width / 2 + fontRenderer.getStringWidth(lvt_8_1_) / 2 + 6;
...
//            }
            ...
            l = x + width / 2 - fontRenderer.getStringWidth(s) / 2;


            String s1 = flag ? s.substring(0, j) : s;
            j1 = this.fontRenderer.drawStringWithShadow((String)this.textFormatter.apply(s1, this.lineScrollOffset), (float)l, (float)i1, i);

            boolean lvt_13_2_ = this.cursorPosition < this.text.length() || this.text.length() >= this.getMaxStringLength();
            int lvt_14_1_ = j1;
            if (!flag) {
                lvt_14_1_ = j > 0 ? l + this.width : l;
            } else if (lvt_13_2_) {
                lvt_14_1_ = j1 - 1;
                --j1;
            }
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                this.fontRenderer.drawStringWithShadow((String)this.textFormatter.apply(s.substring(j), this.cursorPosition), (float)j1, (float)i1, i);
            }

            if (!lvt_13_2_ && this.suggestion != null) {
                this.fontRenderer.drawStringWithShadow(this.suggestion, (float)(lvt_14_1_ - 1), (float)i1, -8355712);
            }
            ...
            if (flag1) {
                if (lvt_13_2_) {
                    ...
                    this.fontRenderer.drawStringWithShadow("_", (float)lvt_14_1_, (float)i1, i);
                }
            }

            if (k != j) {
                int lvt_15_1_ = l + this.fontRenderer.getStringWidth(s.substring(0, k));
                var10002 = i1 - 1;
